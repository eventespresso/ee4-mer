	...
	<form id="event-cart-qty-frm" action="<?php echo $register_url; ?>" method="POST">
		...
		<div id="event-cart-whats-next-buttons" class="event-cart-whats-next-buttons">
			...
			<a class="event-cart-go-back-button event-cart-button button add-hover-fx" href="<?php echo $events_list_url;?>">
				<span class="dashicons dashicons-arrow-left-alt2"></span><?php echo apply_filters( 	'FHEE__EED_Multi_Event_Registration__return_to_events_list_btn_txn',  __( 'Return to Events List', 'event_espresso' ) ); ?>
			</a>

<?php if ( $total_items ) { ?>

			<a class="event-cart-register-button event-cart-button button add-hover-fx"  href="<?php echo $register_url;?>">
				<?php echo apply_filters( 'FHEE__EED_Multi_Event_Registration__proceed_to_registration_btn_txn', __( 'Proceed to Registration', 'event_espresso' ) ); ?><span class="dashicons dashicons-arrow-right-alt2"></span>
			</a>
