		...
		<?php	if ( $total_items ) { ?>
			<span class=" smaller-text">
				<a class="event-cart-empty-cart-lnk empty-cart-lnk event-cart-button button" href="<?php echo $empty_cart_url; ?>">
					<span class="dashicons dashicons-trash"></span><?php echo __( 'empty event cart',
						'event_espresso' ); ?>
				</a>
			</span>
			<span class=" smaller-text">
				<a class="event-cart-update-cart-lnk update-cart-lnk event-cart-button button" href="<?php echo $update_cart_url; ?>">
					<span class="dashicons dashicons-update"></span><?php echo __( 'update event cart', 'event_espresso' ); ?>
				</a>
			</span>
		<?php } // if ( $total_items )  ?>
		</div>
