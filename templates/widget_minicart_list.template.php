...
<div class="ui-widget-content  ui-corner-all">
	...
	<h6 class="event-queue-grand-total right clearfix">
		<span class="event-queue-grand-total-spn"><?php echo __('Grand Total: ', 'event_espresso'); ?></span>
		<span class="event-queue-grand-total-items-spn"><?php printf(  _n( '%s attendee  ', '%s attendees ', $total_items, 'event_espresso' ), $total_items ); ?></span>
		<span class="event-queue-grand-total-price-spn"><?php echo $currency_symbol . $grand_total; ?></span>
	</h6>
	
	<p><a class="minicart-view-event-queue-btn show-if-js button ui-priority-primary ui-state-default ui-corner-all add-hover-fx" href="<?php echo $view_event_queue_url;?>">
